...
export const ProgressItem = ({ label, solved, total, color }) => {
...
export function ProblemProgressCard({ totalProblems, solved }) {
    ...
    const total = totalProblems.Easy + totalProblems.Medium + totalProblems.Hard;
    const solvedCount = solved.length;
    const progressPercent = total > 0 ? solvedCount / total : 0;
