...
import { createCompanies, deleteCompany, getAllCompanies, updateCompany } from '@/api/companyApi'
import { useAppDispatch, useAppSelector } from "@/redux/hook";
import { editCompany, setCompanies, removeCompany } from "@/redux/slice/companySlice";
...
export function ManageCompanies() {
    ...
    const handleNewCompanyChange = (index, value) => {
