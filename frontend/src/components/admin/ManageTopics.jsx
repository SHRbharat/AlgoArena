...
import { createTopics, deleteTopic, getAllTopics, updateTopic } from "@/api/topicApi";
import { editTopic, setTopics, removeTopic } from "@/redux/slice/topicSlice";
...
export function ManageTopics() {
    ...
    const handleNewTopicChange = (index, value) => {
