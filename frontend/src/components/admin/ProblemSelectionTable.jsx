...
export function ProblemSelectionTable({
    ...
    const handleMultiSelectChange = (filterType, values) => {
        if (filterType === "topic") {
            setTopicFilter(topics.filter(topic => values.includes(topic.id)))
        } else {
            setCompanyFilter(companies.filter(company => values.includes(company.id)))
        }
    }
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4">
                ...
                <div className="w-full sm:w-40">
                    <MultiSelect
                        ...
                        onChange={(values) => handleMultiSelectChange('company', values)}
